...
class AppConstants {
  ...
  static const Map<String, List<String>> categorizedMessages = {
    'Check-ins': [
      ...
      "Hope this week's been going okay. How are you going?",
      "Just checking in, how's things on your end?",
    ],
    'Support & Struggle': [
      "Hey, it's been a bit of a tough week for me. How's your week going?.",
      "Been finding today a bit harder than usual. How's yours been?",
      "Not been the easiest few days. How's everything going for you?",
      "I'm struggling right now. How are you going?",
      "Trying my best today, but it's been hard. How are you travelling?",
    ],
    'Confession': [
