...
class AppColors {
  ...
  static const Color primary =
      Color(0xFF007AFF); // iOS system blue - our main accent
  ...
  static const Color tertiary =
      Color(0xFF34C759); // iOS system green (for success only)
  static const Color accent =
      Color(0xFFFF9500); // iOS system orange (for warnings only)
  ...
  static const Color afternoonColor =
      Color(0xFFFFBF65); // Warm amber for afternoon
  static const Color eveningColor =
      Color(0xFF5E6CE7); // Purple-blue for evening
